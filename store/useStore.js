...
const defaultState = {
  ...
  lightcone: {
    l1: { img: "", name: "", path: "", point: [], s:1 },
    l2: { img: "", name: "", path: "", point: [], s:1 },
    l3: { img: "", name: "", path: "", point: [], s:1 },
    l4: { img: "", name: "", path: "", point: [], s:1 },
    l5: { img: "", name: "", path: "", point: [], s:1 },
    l6: { img: "", name: "", path: "", point: [], s:1 },
    l7: { img: "", name: "", path: "", point: [], s:1 },
    l8: { img: "", name: "", path: "", point: [], s:1 },
    l9: { img: "", name: "", path: "", point: [], s:1 },
    l10: { img: "", name: "", path: "", point: [], s:1 },
    l11: { img: "", name: "", path: "", point: [], s:1 },
    l12: { img: "", name: "", path: "", point: [], s:1 },
    l13: { img: "", name: "", path: "", point: [], s:1 },
    l14: { img: "", name: "", path: "", point: [], s:1 },
    l15: { img: "", name: "", path: "", point: [], s:1 },
    l16: { img: "", name: "", path: "", point: [], s:1 },
  },
  state: {
